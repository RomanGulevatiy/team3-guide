...
**Гілка** - це ваш особистий "рядок" змін, ізольований від основного коду. Це потрібно щоб твої незакінчені зміни не ламали проєкт для інших.

> [!CAUTION]
> **Головне правило:** Ми ніколи не пишемо код напряму в гілкі `main`!
...
> Перед типом задачі радиться вказувати поточний спринт `sprint-n/`.\
